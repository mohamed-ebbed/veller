                ...
                <div class="card-body">
                    <form method="POST" action="{{route('opportunity.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="description" class="form-control" rows="4" style="width: 46%; margin-left: 2%"></textarea>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="requirements" class="form-control" rows="2" style="width: 46%; margin-left: 2%"></textarea>
                        </div>
                        <div class="form-group row">
