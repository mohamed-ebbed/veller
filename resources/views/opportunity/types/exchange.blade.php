...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="especialization" type="text" class="form-control{{ $errors->has('especialization') ? ' is-invalid' : '' }}" name="especialization" value="{{ old('especialization') }}" required autofocus>
...
<div class="form-group row">
    ...
    <textarea name="countries" class="form-control" rows="2" style="width: 46%; margin-left: 2%"></textarea>
</div>
@endsection