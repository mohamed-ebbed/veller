...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="ispecialization" type="text" class="form-control{{ $errors->has('ispecialization') ? ' is-invalid' : '' }}" name="ispecialization" value="{{ $type['specialization'] }}" required autofocus>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <select name="ipaid" class="form-control" value="$type['paid']">
            <option>yes</option>
            <option>no</option>
        </select>
        @if ($errors->has('ipaid'))
