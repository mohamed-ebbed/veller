...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="cspecialization" type="text" class="form-control{{ $errors->has('cspecialization') ? ' is-invalid' : '' }}" name="cspecialization" value="{{ old('cspecialization') }}" required autofocus>
...
<div class="form-group row">
    ...
    <textarea name="prizes" class="form-control" rows="2" style="width: 46%; margin-left: 2%"></textarea>
</div>
@endsection